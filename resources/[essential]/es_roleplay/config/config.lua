...
uSettings.chatTags = {
	{rank = 1, tag = "[Moderator]"},
	{rank = 3, tag = "[Admin]"},
	{rank = 5, tag = "[Head-Admin]"},
	{rank = 7, tag = "[Developer]"}
}

-- Gets ran on new player join
uSettings.firstSpawned = function(source)
	TriggerClientEvent('chatMessage', source, '', {255, 0, 0}, "Welcome to ^4Beyond RP^7, " .. "^4" .. GetPlayerName(source) .. "^7.")
	TriggerClientEvent('chatMessage', source, '', {255, 0, 0}, "Join our Discord at BeyondRP.com.")
end
...
uSettings.enableChopshops = false
